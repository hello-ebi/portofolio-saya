...
<div className="z-30 -translate-y-10 -translate-x-1 lg:-translate-y-9 lg:-translate-x-5 top-0 mt-3">
  <img src={ebilogogif} alt="ebi" className="w-[150px]" />
</div>


        <ul className="md:flex flex flex-row space-x-4 md:block absolute -translate-y-10 -translate-x-5 lg:-translate-y-6 md:static w-full md:w-auto top-14 md:top-0 transition-all justify-end">
          <li>
          ...
          <li><a href="#portfolio" className="relative inline-block after:block after:h-[2px] p-2 after:bg-yellow-400 after:scale-x-0 after:origin-center hover:after:scale-x-100 after:transition-transform">
             <FaBriefcase className="text-xl md:hidden" />
