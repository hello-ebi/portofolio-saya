...
<div className="z-30 -translate-y-[25%] translate-x-[5%] lg:-translate-y-9 lg:-translate-x-5 top-0 mt-3">
  <img src={ebilogogif} alt="ebi" className="w-[150px]" />
        ...
        <ul className="md:flex flex flex-row items-end md:block absolute -translate-y-[90%] translate-x-[85%] gap-2
         lg:-translate-y-6 lg:translate-x-5 md:static md:w-auto top-14 md:top-0 transition-all justify-end">
          <li>
